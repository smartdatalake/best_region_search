...
public class BCAIndexProgressiveDivExhaustive extends BCAFinder<POI> {
	...
	public BCAIndexProgressiveDivExhaustive(double decayConstant, UtilityScoreFunction utilityScoreFunction) {
		super();
